...
class Loader extends Singleton implements LoaderInterface
{
    ...
    public function registerNamespace(string $namespace, array $data): void
    {
    ...
    public function runEditor(): void
    {
        foreach ($this->namespaces as $namespace => $data) {
    ...
    public function loadStyles(string $namespace, Manifest $manifest, array $assets): void
    {
    ...
    public function loadScripts(string $namespace, Manifest $manifest, array $assets): void
    {
    ...
    public function loadEditorStyles(string $namespace, Manifest $manifest, array $assets): void
    {
